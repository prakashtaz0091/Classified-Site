...
urlpatterns = [
    ...
    path('create_field_options_extra/',views.create_field_options_extra,name='create_field_options_extra'),
    path('create_field_options_extra_content/',views.create_field_options_extra_content,name='create_field_options_extra_content'),
